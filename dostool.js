...
rem %flag1% for /f "delims=" %%o in ('""%EverythingInstallPath%\es.exe" -sort path-descending /ad-l %caozuo%:"') do rd/q "%%o"2>nul&&echo ÒÑÉ¾³ı¿ÕÎÄ¼ş¼Ğ%%o
:loop1
%flag1% set empty=0
...
echo ½âÂëÄÚÈİ:
if exist %temp%\codetmp (type %temp%\codetmp) else (echo ½âÂëÊ§°Ü)
echo;
echo _______________________________________________________________________________
set bxz=
