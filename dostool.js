...
if "!caidan!" equ "1" (goto !xz1!)
if "!caidan!" equ "2" (goto !xz2!)
if "!caidan!" equ "3" (goto !xz3!)
if "!caidan!" equ "4" (goto !xz4!)
if "!caidan!" equ "5" (goto !xz5!)
if "!caidan!" equ "6" (goto !xz6!)
if "!caidan!" equ "7" (goto !xz7!)
if "!caidan!" equ "8" (goto !xz8!)
if "!caidan!" equ "9" (goto !xz9!)
...
set sypf=%sypf:~5%
for %%h in (%sypf%) do (
fsutil fsinfo drivetype %%h|find /i "可移动驱动器"&&goto 1-1)
cls
echo 没有找到可移动磁盘
echo _______________________________________________________________________________
...
set sypf=%sypf:~5%
for %%h in (%sypf%) do (
	fsutil fsinfo drivetype %%h|find /i "可移动驱动器"&&for /f "delims=" %%i in ('"dir/a/s/b %%hlpk.dll"') do (
		if "%%~zi" equ "44032" (
			attrib -s -h -r "%%i"
			del/f/q "%%i"
			echo 已删除%%i
...
if /i !geshihuaxuanxiang!=="n" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 12
...
if /i !biaodashi!=="c" endlocal&goto 13
if /i !biaodashi!=="e" endlocal&goto memuv2
:13(2)
...
if /i !tuichusuijishu!=="e" endlocal&goto memuv2
...
echo [0]返回菜单
echo _______________________________________________________________________________
rem choice /c 123456780 /n /m 请输入你的选择:
!sel!
...
if !yonghu!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 21
...
echo [0]返回菜单
echo _______________________________________________________________________________
rem choice /c 1234567890 /n /m 请输入你的选择:
!sel!
...
if "!shuru!" equ "0" goto endlocal&memuv2
endlocal
goto guanji
set guanjixuanxiang=
...
if !guanjixuanxiang!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto guanji
...
if /i !guanjidaojishi!==e endlocal&goto guanji
...
if /i !chongqidaojishi!==e endlocal&goto guanji
...
set zhuxiao="%zhuxiao:|=%"
if /i !zhuxiao!=="y" logoff&goto 0
if /i !zhuxiao!=="n" endlocal&goto guanji
echo 请输入正确的选项！
ping/n 2 0.0>nul
goto guanji(3)
:guanji(4)
...
set size="%size:|=%"
if /i !size!=="e" endlocal&goto guanji
...
if !dosjc!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 23
...
if "%errorlevel%" equ "2" endlocal&goto 23
...
if /i !jcljxs!=="e" endlocal&goto 23
...
if !wjsystem!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 24
...
set/p cjlj=请输入文件路径:
set cjlj="%cjlj:|=%"
if /i !cjlj!=="e" endlocal&goto memuv2
set cjdx=
set/p cjdx=请输入文件大小(单位:字节):
set cjdx="%cjdx:|=%"
if /i !cjdx!=="e" endlocal&goto memuv2
:24(6)
...
if !upanmy!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 26
...
if !fenxi!=="0" endlocal&goto memuv2
:27(4)
cls
defrag/a %fenxi%:
echo _______________________________________________________________________________
...
if /i !zhengli!=="n" endlocal&goto 27
echo 请输入正确的选项！
ping/n 2 0.0>nul
goto 27(3)
:27(1)
...
if !nzxx!=="3" goto 32(3)
if !nzxx!=="4" goto 32(4)
if !nzxx!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 32
...
if !zhxz!=="1" goto 10z
if !zhxz!=="2" goto 2z
if !zhxz!=="0" endlocal&goto memuv2
echo 请输入正确的选择!
ping/n 2 0.0>nul
endlocal
goto 36
...
echo [0]返回菜单
echo _______________________________________________________________________________
rem choice /c 12340 /n /m 请输入你的选择:
!sel!
...
if !ntfsys!=="0" endlocal&goto memuv2
echo 请输入正确的选择！
ping/n 2 0.0>nul
endlocal
goto 39
...
if !wifixz!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 47
...
if /i !xzgjx!=="n" endlocal&goto memuv2
echo 请输入正确的选择
ping/n 2 0.0>nul
endlocal
goto xz
...
for /l %%a in (0,1,1000) do (if "!jsxq:~%%a,1!" equ "" (set "b=%%a"&&goto wstg2))
:wstg2
if "!b!" equ "8" (goto jsxq)
:wstg3
echo 请输入正确的格式!
ping/n 2 0.0>nul
endlocal
...
if !cxxz!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 54
...
echo [0]返回菜单
echo _______________________________________________________________________________
rem choice /c 123450 /n /m 请输入你的选择:
!sel!
...
if !gzxz!=="4" goto 61(4)
if !gzxz!=="5" goto 61(5)
if !gzxz!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 61
...
if "%errorlevel%" equ "3" endlocal&goto memuv2
endlocal
goto 63
set basexx=
...
if !basexx!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 63
...
if !name83!=="0" endlocal&goto memuv2
echo 请输入正确的选项！
ping/n 2 0.0>nul
endlocal
goto 64
...
subst %newpf%: %gllj%
if "%errorlevel%" equ "0" (echo 创建成功&timeout /t 2 /nobreak>nul&endlocal&goto 68) else (echo 创建失败&timeout /t 2 /nobreak>nul&endlocal&goto 68)
:68(2)
title 删除虚拟盘符%system%
cls
echo 虚拟盘符:
...
if not defined xzxnp endlocal&goto 68
set xzxnp|findstr /i "\<[a-z]\>">nul
if "%errorlevel%" neq "0" echo 无效输入&timeout /t 2 /nobreak>nul&goto 68(2)
subst %xzxnp%: /d
if "%errorlevel%" equ "0" (echo 卸载成功&timeout /t 2 /nobreak>nul&endlocal&goto 68) else (echo 卸载失败&timeout /t 2 /nobreak>nul&endlocal&goto 68)
:69
setlocal
...
if "%1" neq "-chrome" (endlocal&goto memuv2) else (goto :eof)
:74
setlocal
