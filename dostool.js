...
ª|ëšôÍÇèÒ¯¬}–x˜à’°‘Y°şªm‘@—I¶Ø”ÔÎÎâ–Z„Š°Ö¡À²œ‰›I´ôÂÔ’±
ÓÓìÍ”Œ¬†Ì­ìÍÌØ–ï°æÕû„uª†é²’¯êÊ›»äñì¥”šëŸ‘°çœ‚•’™L€®tÌêä¥
...
if /i "!system!" equ "Microsoft Windows XP Home" (set system=Windows XP ¼ÒÍ¥°æ)
if /i "!system!" equ "Microsoft Windows XP Professional" (set system=Windows XP ×¨Òµ°æ)
if /i "!system!" equ "Microsoft Windows 7 Ultimate" (set system=Windows 7 Æì½¢°æ)
if /i "!system!" equ "Microsoft Windows 7 Home Basic" (set system=Windows 7 ¼ÒÍ¥ÆÕÍ¨°æ)
if /i "!system!" equ "Microsoft Windows 7 Home Premium" (set system=Windows 7 ¼ÒÍ¥¸ß¼¶°æ)
if /i "!system!" equ "Microsoft Windows 7 Professional" (set system=Windows 7 ×¨Òµ°æ)
if /i "!system!" equ "Microsoft Windows 7 Enterprise" (set system=Windows 7 ÆóÒµ°æ)
if /i "!system!" equ "Microsoft Windows 8 Pro" (set system=Windows 8 ×¨Òµ°æ)
if /i "!system!" equ "Microsoft Windows 8 China" (set system=Windows 8 ÖĞ¹ú°æ)
if /i "!system!" equ "Microsoft Windows 8 Enterprise" (set system=Windows 8 ÆóÒµ°æ)
if /i "!system!" equ "Microsoft Windows 8.1 Pro" (set system=Windows 8.1 ×¨Òµ°æ)
if /i "!system!" equ "Microsoft Windows 8.1 China" (set system=Windows 8.1 ÖĞ¹ú°æ)
if /i "!system!" equ "Microsoft Windows 8.1 Enterprise" (set system=Windows 8.1 ÆóÒµ°æ)
if /i "!system!" equ "Microsoft Windows 10 Home" (set system=Windows 10 ¼ÒÍ¥°æ)
if /i "!system!" equ "Microsoft Windows 10 Professional" (set system=Windows 10 ×¨Òµ°æ)
if /i "!system!" equ "Microsoft Windows 10 Education" (set system=Windows 10 ½ÌÓı°æ)
if /i "!system!" equ "Microsoft Windows 10 Enterprise" (set system=Windows 10 ÆóÒµ°æ)
if /i "!system!" equ "Microsoft Windows 11 Home" (set system=Windows 11 ¼ÒÍ¥°æ)
if /i "!system!" equ "Microsoft Windows 11 Professional" (set system=Windows 11 ×¨Òµ°æ)
if /i "!system!" equ "Microsoft Windows 11 Education" (set system=Windows 11 ½ÌÓı°æ)
if /i "!system!" equ "Microsoft Windows 11 Enterprise" (set system=Windows 11 ÆóÒµ°æ)
if /i "%date:~11,2%"=="ÖÜÒ»" set xingqi=ĞÇÆÚÒ»
if /i "%date:~11,2%"=="ÖÜ¶ş" set xingqi=ĞÇÆÚ¶ş
if /i "%date:~11,2%"=="ÖÜÈı" set xingqi=ĞÇÆÚÈı
if /i "%date:~11,2%"=="ÖÜËÄ" set xingqi=ĞÇÆÚËÄ
if /i "%date:~11,2%"=="ÖÜÎå" set xingqi=ĞÇÆÚÎå
if /i "%date:~11,2%"=="ÖÜÁù" set xingqi=ĞÇÆÚÁù
if /i "%date:~11,2%"=="ÖÜÈÕ" set xingqi=ĞÇÆÚÌì
if /i "%date:~11,3%"=="ĞÇÆÚÒ»" set xingqi=ĞÇÆÚÒ»
if /i "%date:~11,3%"=="ĞÇÆÚ¶ş" set xingqi=ĞÇÆÚ¶ş
if /i "%date:~11,3%"=="ĞÇÆÚÈı" set xingqi=ĞÇÆÚÈı
if /i "%date:~11,3%"=="ĞÇÆÚËÄ" set xingqi=ĞÇÆÚËÄ
if /i "%date:~11,3%"=="ĞÇÆÚÎå" set xingqi=ĞÇÆÚÎå
if /i "%date:~11,3%"=="ĞÇÆÚÁù" set xingqi=ĞÇÆÚÁù
if /i "%date:~11,3%"=="ĞÇÆÚÈÕ" set xingqi=ĞÇÆÚÌì
set nx1=[+]ÏÂÒ»Ò³&set nx=[-]ÉÏÒ»Ò³   [+]ÏÂÒ»Ò³&set nx7=[-]ÉÏÒ»Ò³
)
)
for /f "tokens=2 delims=={}" %%a in ('wmic PATH Win32_SystemEnclosure get ChassisTypes/value') do (
if %%a==8 set nx1=[S]ÏÂÒ»Ò³&set nx=[A]ÉÏÒ»Ò³   [S]ÏÂÒ»Ò³&set nx7=[A]ÉÏÒ»Ò³
if %%a==9 set nx1=[S]ÏÂÒ»Ò³&set nx=[A]ÉÏÒ»Ò³   [S]ÏÂÒ»Ò³&set nx7=[A]ÉÏÒ»Ò³
if %%a==10 set nx1=[S]ÏÂÒ»Ò³&set nx=[A]ÉÏÒ»Ò³   [S]ÏÂÒ»Ò³&set nx7=[A]ÉÏÒ»Ò³)
(
set sc=delasd123
set scw=rdasd123
set ad=
...
fltmc 1>nul 2>nul
if %errorlevel% neq 0 (echo ²¿·Ö¹¦ÄÜÎŞ·¨Õı³£Ê¹ÓÃ£¬ÇëÒÔ¹ÜÀíÔ±Éí·İÔËĞĞ
...
goto zhcl
:zcm
for /f "delims=" %%a in ('"reg query HKEY_CURRENT_USER\System\DOS¹¤¾ßÏä /v »úÆ÷Âë 2>nul|find "»úÆ÷Âë""') do (set sfzc=%%a)
set sfzc=%sfzc:~21%
...
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
reg add HKEY_CURRENT_USER\System\DOS¹¤¾ßÏä /v »úÆ÷Âë /d %jqm% /f>nul 2>nul
...
set/a cishu-=1
echo ÃÜÂë´íÎó£¡Äã»¹ÓĞ%cishu%´Î»ú»á
ping/n 2 0.0>nul
if %cishu%==0 goto 00
goto mima
:mima1
...
cls
if !winv! equ 0 (echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m!memuys!!cswz!!ysbak!Ò³) else (
set /p =!cswz1!¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡²Ëµ¥ - µÚ<nul
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m1!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]Çå³ıUÅÌÀïµÄlpk.dll²¡¶¾
echo [2]Çå³ıUÅÌÀïµÄjwgkvsq.vmx²¡¶¾£¬²¢ÃâÒß¸Ã²¡¶¾
echo [3]ÇåÀíÏµÍ³À¬»ø
echo [4]ÏÔÊ¾ÏµÍ³ĞÅÏ¢
echo [5]½â³ıÈÎÎñ¹ÜÀíÆ÷±»½ûÓÃ
echo [6]ÏÔÊ¾±»Òş²ØÎÄ¼ş(ÖĞÁË¸ÃÀà²¡¶¾ºó)
echo [7]½â³ı×¢²á±í±»½ûÓÃ
echo [8]¼ÆËã¿ªÆ½·½
echo [9]ÇĞ»»µ½ÃüÁîÌáÊ¾·û
echo [0]ÍË³ö                                                         !cswz!42;97m%nx1%!cswz!!ysbak!
echo _______________________________________________________________________________
set caidan=
set/p caidan=ÇëÊäÈëÄãµÄÑ¡Ôñ:
if "!caidan!"=="1" goto 01
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m2!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]½«´ÅÅÌ¸ñÊ½×ª»»ÎªNTFS
echo [2]´ÅÅÌ´íÎóĞŞ¸´
echo [3]¸ñÊ½»¯
echo [4]DOS¼ÆËãÆ÷
echo [5]½â³ıÃüÁîÌáÊ¾·û±»½ûÓÃ
echo [6]Ëæ»úÊıÉú³ÉÆ÷
echo [7]Çå³ıKHATRA²¡¶¾
echo [8]´ò¿ª×¢²á±í
echo [9]´ò¿ª¿ØÖÆÃæ°å
echo [0]ÍË³ö                                             !cswz!42;97m%nx%!cswz!!ysbak!
echo _______________________________________________________________________________
set caidan=
set/p caidan=ÇëÊäÈëÄãµÄÑ¡Ôñ:
if "!caidan!"=="1" goto 10
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m3!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]´ò¿ªDirectXÕï¶Ï¹¤¾ß
echo [2]´ò¿ª¼ÆËã»ú¹ÜÀí
echo [3]ÓÃ»§¹ÜÀí
echo [4]´ò¿ª×é²ßÂÔ
echo [5]DOSÈÎÎñ¹ÜÀíÆ÷
echo [6]ÎÄ¼şÏµÍ³ĞÅÏ¢²éÑ¯
echo [7]´´½¨Ö¸¶¨´óĞ¡µÄÎÄ¼ş
echo [8]ÃâÒßUÅÌ²¡¶¾
echo [9]´ÅÅÌËéÆ¬ÕûÀí
echo [0]ÍË³ö                                             !cswz!42;97m%nx%!cswz!!ysbak!
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m4!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]Ò»¼üÉ¾³ı¿ÕÎÄ¼ş¼Ğ
echo [2]ping²âÊÔÍøÂçÑÓ³Ù
echo [3]Ó²¼ş¼ì²â
echo [4]¶ÁĞÄÊõ
echo [5]DOSÄÖÖÓ
echo [6]¼ÆÊ±Æ÷
echo [7]Ëæ»úÃÜÂëÉú³ÉÆ÷
echo [8]É¾³ıÃ¿¸öÅÌ·ûÏÂµÄSystem Volume InformationÎÄ¼ş¼Ğ
echo [9]¶ş½øÖÆ×ª»»Æ÷
echo [0]ÍË³ö                                             !cswz!42;97m%nx%!cswz!!ysbak!
echo _______________________________________________________________________________
set caidan=
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m5!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]ÎÄ±¾ä¯ÀÀ
echo [2]ÏÔÊ¾¼ÆËã»úÓëÓÃ»§µÄÉèÖÃ
echo [3]NTFSÑ¹Ëõ
echo [4]ĞŞ¸ÄÎÄ¼şÈ¨ÏŞ
echo [5]ÏÔÊ¾¿ª»úÆô¶¯Ïî
echo [6]ÓïÒôÔÄ¶ÁÆ÷
echo [7]Åú´¦ÀíÎÄ¼ş·çÏÕ·ÖÎö
echo [8]ÎÄ¼şËÑË÷
echo [9]ĞŞ¸´ÒÑËğ»µµÄÎÄ¼ş
echo [0]ÍË³ö                                             !cswz!42;97m%nx%!cswz!!ysbak!
echo _______________________________________________________________________________
set caidan=
set/p caidan=ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m6!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]±©Á¦ÆÆ½âÑ¹Ëõ°üÃÜÂë
echo [2]WifiÈÈµã
echo [3]·´±àÒëchmÎÄ¼ş
echo [4]¹Ø±ÕÎŞÏìÓ¦½ø³Ì
echo [5]ÎÄ¼ş±È½ÏÆ÷
echo [6]½«ÎÄ×ÖĞ´Èë¼ôÇĞ°å
echo [7]´ò¿ªÏµÍ³·şÎñÉèÖÃ
echo [8]ÒÑÖªÄêÔÂÈÕ¼ÆËãĞÇÆÚ
echo [9]²éÑ¯ÏµÍ³¼¤»î×´Ì¬
echo [0]ÍË³ö                                             !cswz!42;97m%nx%!cswz!!ysbak!
echo _______________________________________________________________________________
set caidan=
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m7!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]´´½¨Ö¸¶¨ÎÄ¼şµÄ¿ì½İ·½Ê½µ½×ÀÃæ
echo [2]´ò¿ªÏµÍ³ÅäÖÃ
echo [3]×ÖÊıÍ³¼Æ
echo [4]´´½¨·ûºÅÁ´½Ó
echo [5]´ò¿ª¹ÜÀí¿ØÖÆÌ¨
echo [6]½â³ıStreamsÎÄ¼şËø¶¨
echo [7]´´½¨¡¢É¾³ı»òÁĞ³ö¾í×°Èëµã
echo [8]×¢²á±íËÑË÷
echo [9]Base64±à½âÂë
echo [0]ÍË³ö                                             !cswz!42;97m%nx%!cswz!!ysbak!
echo _______________________________________________________________________________
...
title DOS¹¤¾ßÏä - %system%%gxflag%
cls
echo                                     ²Ëµ¥ - µÚ!cswz!!ysbak:~0,3!92m8!cswz!!ysbak!Ò³
echo ÏÖÔÚÊÇ%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%
echo _______________________________________________________________________________
echo [1]8.3¶ÌÎÄ¼şÃû¹ÜÀí
echo [2]ÖÇÄÜNTFSÑ¹Ëõ
echo [3]¼ÆËãÎÄ¼ş¹şÏ£Öµ
echo [4]ÏÔÊ¾»õ±Ò»ãÂÊ
echo [5]´´½¨ĞéÄâÅÌ·û
echo [6]½âÑ¹msi°²×°ÎÄ¼ş
echo [7]Éú³ÉCMD¿ØÖÆÌ¨É«²Ê±í
echo [8]KMS¼¤»îWindows 10
echo [0]ÍË³ö                                                      !cswz!42;97m%nx7%!cswz!!ysbak!
echo _______________________________________________________________________________
set caidan=
set/p caidan=ÇëÊäÈëÄãµÄÑ¡Ôñ:
if "!caidan!"=="1" goto 64
...
cls
echo °´ÈÎÒâ¼ü¿ªÊ¼Çå³ılpl.dll²¡¶¾&pause>nul
cls
echo ÕıÔÚËÑË÷¿ÉÒÆ¶¯´ÅÅÌ...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for %%h in (%sypf%) do (
fsutil fsinfo drivetype %%h|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&goto 01-1)
cls
...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for %%h in (%sypf%) do fsutil fsinfo drivetype %%h|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&for /f "delims=" %%i in ('"dir/a/s/b %%hlpk.dll"') do if %%~zi==44032 attrib -s -h -r "%%i"|del/f/q "%%i"|echo ÒÑÉ¾³ı%%i
echo _______________________________________________________________________________
echo Çå³ıÍê³É
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto memuv2
...
cls
echo °´ÈÎÒâ¼ü¿ªÊ¼Çå³ıjwgkvsq.vmx²¡¶¾&pause>nul
cls
echo ÕıÔÚËÑË÷¿ÉÒÆ¶¯´ÅÅÌ...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for %%j in (%sypf%) do (
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&goto 02-1)
cls
echo Ã»ÓĞÕÒµ½¿ÉÒÆ¶¯´ÅÅÌ
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
...
set sypf=%sypf:~5%
for %%j in (%sypf%) do (
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&takeown/f "%%jautorun.inf"
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&echo y|cacls "%%jautorun.inf" /t /c /p everyone:f
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&takeown/f "%%jRECYLER"
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&echo y|cacls "%%jRECYCLER" /t /c /p everyone:f
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&attrib -s -h -r "%%jautorun.inf"
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&del/f/q "%%jautorun.inf"
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&rd/s/q "%%jRECYCLER"
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&del/f/q "%%jRECYCLER"
fsutil fsinfo drivetype %%j|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&echo jwgkvsq.vmx²¡¶¾ÃâÒßÎÄ¼ş£¬ÇëÎğÉ¾³ı£¡>"%%jRECYCLER")
echo _______________________________________________________________________________
echo Çå³ıÍê³É
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto memuv2
...
cls
echo %sbak%µÄ¿ªÆ½·½½á¹ûÊÇ(¾«È·µ½Ğ¡Êıµãºó%wbak%Î»):
echo %sqrt%
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto memuv2
...
echo _______________________________________________________________________________
echo Èç¹û²»ÄÜÕı³£×ª»»£¬ÇëÊ¹ÓÃ´ÅÅÌ´íÎóĞŞ¸´
set zhuanhuancipan=
set/p zhuanhuancipan=ÇëÊäÈëĞèÒª×ª»»µÄÅÌ·û:
cls
...
echo _______________________________________________________________________________
set cipanxioufu=
set/p cipanxioufu=ÇëÊäÈëĞèÒªĞŞ¸´µÄÅÌ·û:
cls
...
echo _______________________________________________________________________________
set geshihua=
set/p geshihua=ÇëÊäÈëĞèÒª¸ñÊ½»¯µÄÅÌ·û:
cls
...
cls
echo ´Ë¹¤¾ßÖ»¿ÉÒÔÓÃÓÚ´¿ÎÄ±¾ÎÄ¼ş¼ÓÃÜ
echo _______________________________________________________________________________
echo [1]ÎÄ¼ş¼ÓÃÜ(·½·¨1)
echo [2]ÎÄ¼ş½âÃÜ
echo [3]ÎÄ¼ş¼ÓÃÜ(·½·¨2)(ÍÆ¼öÊ¹ÓÃ)
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
set batjmxx=
set/p batjmxx=ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
goto batjiami
:batjiami(1)
title ÎÄ¼ş¼ÓÃÜ(·½·¨1) - %system%
del/f/q %systemdrive%linshiwenjian.tmp>nul
cls
echo ÎÄ¼ş¼ÓÃÜ(·½·¨1)
echo _______________________________________________________________________________
echo ¼ÓÃÜÎÄ¼ş»áÔÚ×ÀÃæÉú³É(e=·µ»Ø):
echo _______________________________________________________________________________
set jiami=
set/p jiami=ÍÏ¶¯ĞèÒª¼ÓÃÜµÄÎÄ¼şµ½´Ë´°¿Ú:
...
copy/b %systemdrive%1.tmp+%systemdrive%2.tmp+%systemdrive%linshiwenjian.tmp "%zmlj%ÒÑ¼ÓÃÜµÄ%wjm%.%geshi%"
...
goto batjiami
:batjiami(2)
title ÎÄ¼ş½âÃÜ - %system%
del/f/q %systemdrive%linshiwenjian.tmp>nul
cls
echo ÎÄ¼ş½âÃÜ
echo _______________________________________________________________________________
echo ½âÃÜÎÄ¼ş»áÔÚ×ÀÃæÉú³É(e=·µ»Ø)
echo _______________________________________________________________________________
set jiemi=
set/p jiemi=ÍÏ¶¯ĞèÒª½âÃÜµÄÎÄ¼şµ½´Ë´°¿Ú:
...
copy/b %systemdrive%3.tmp+%systemdrive%linshiwenjian.tmp "%zmlj%ÒÑ½âÃÜµÄ%wjm%.%geshi%"
del/f/q 3.tmp
del/f/q %systemdrive%linshiwenjian.tmp
cls
echo _______________________________________________________________________________
...
copy/b %systemdrive%4.tmp+%systemdrive%5.tmp+%systemdrive%linshiwenjian.tmp "%zmlj%ÒÑ¼ÓÃÜµÄ%wjm%.%geshi%"
...
:batjiami(3)
cls
title ÎÄ¼ş¼ÓÃÜ(·½·¨2) - %system%
echo ÎÄ¼ş¼ÓÃÜ(·½·¨2)
echo _______________________________________________________________________________
echo ¼ÓÃÜÎÄ¼ş»áÔÚ×ÀÃæÉú³É(e=·µ»Ø)
echo _______________________________________________________________________________
set jiami2=
set/p jiami2=ÍÏ¶¯ĞèÒª¼ÓÃÜµÄÎÄ¼şµ½´Ë´°¿Ú:
...
copy/b %systemdrive%temp+%systemdrive%temp.0 "%zmlj%ÒÑ¼ÓÃÜµÄ%wjm%.%geshi%"
...
goto batjiami
:13
title DOS¼ÆËãÆ÷ - %system%
cls
echo _______________________________________________________________________________
echo ×¢Òâ:DOS¼ÆËãÖ»ÄÜ½øĞĞÕûÊıÔËËã£¬¼ÆËã½á¹ûÖ»ÄÜ¾«È·µ½ÕûÊı
echo ÓĞĞ§ÊıÖµ·¶Î§(-2147483648ÖÁ2147483647)(c=ÇåÆÁ e=·µ»Ø)
echo _______________________________________________________________________________
:13(1)
set biaodashi=
...
set/a cs=0
cls
echo ËµÃ÷:Ö»ÄÜÊäÈëÕûÊı£¬Ëæ»úÊı·¶Î§(0-32767)(e=·µ»Ø²Ëµ¥)
echo _______________________________________________________________________________
set zuidazhi=
set zuixiaozhi=
set/p zuidazhi=ÇëÊäÈëËæ»úÊıµÄ×î´óÖµ:
set/p zuixiaozhi=ÇëÊäÈëËæ»úÊıµÄ×îĞ¡Öµ:
echo _______________________________________________________________________________
:15(1)
set/a cs+=1
set/a zdzcl=%zuidazhi%+1
set/a suijishu=%random%%%(%zdzcl%-%zuixiaozhi%)+%zuixiaozhi%
echo µÚ%cs%´Î²úÉúµÄËæ»úÊı:%suijishu%
:15(3)
set tuichusuijishu=
...
goto 15(3)
:16
title Çå³ıKHATRA²¡¶¾ - %system%
cls
echo °´ÈÎÒâ¼ü¿ªÊ¼Çå³ıKHATRT²¡¶¾&pause>nul
cls
echo ÕıÔÚ½áÊøKHATRA²¡¶¾½ø³Ì...
ping/n 2 0.0>nul
:16(4)
set khatra=0
:16(4)(1)
...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for /f "delims=" %%a in ('"for %%b in (%sypf%) do dir/a/s/b %%b*.exe"') do if %%~za==486912 attrib -s -h -r "%%a"|del/f/q "%%a"|echo ÒÑÉ¾³ı%%a
for /f "delims=" %%c in ('"for %%d in (%sypf%) do dir/a/s/b %%dautorun.inf"') do if %%~zc==234 attrib -s -h -r "%%c"|del/f/q "%%c"|echo ÒÑÉ¾³ı%%c
...
echo _______________________________________________________________________________
set zhucebiaoqingli=
set/p zhucebiaoqingli=×¢²á±íĞèÒªÊÖ¶¯ÇåÀí.ÊÇ·ñ´ò¿ª×¢²á±í(y/n):
...
echo [2]´´½¨ĞÂÓÃ»§
echo [3]É¾³ıÓÃ»§
echo [4]ÌáÉıÓÃ»§Îª¹ÜÀíÔ±
echo [5]Ç¿ÖÆĞŞ¸ÄÓÃ»§ÃÜÂë
echo [6]²é¿´ÓÃ»§ĞÅÏ¢
echo [7]¼¤»îÕË»§
echo [8]Í£ÓÃÕË»§
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 123456780 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
goto 21
:21(1)
title ÏÔÊ¾ËùÓĞµÄÓÃ»§ - %system%
cls
echo _______________________________________________________________________________
net user
echo _______________________________________________________________________________
echo µ±Ç°ÒÑµÇÂ¼µÄÓÃ»§:%username%
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
goto 21
:21(2)
title ´´½¨ĞÂÓÃ»§ - %system%
cls
echo ×¢Òâ:´´½¨µÄÓÃ»§ÀàĞÍÎªÆÕÍ¨ÓÃ»§
echo _______________________________________________________________________________
net user
echo _______________________________________________________________________________
echo µ±Ç°ÒÑµÇÂ¼µÄÓÃ»§:%username%
...
set xinyonghuming=
set xinyonghumima=
set/p xinyonghuming=ÓÃ»§Ãû:
set/p xinyonghumima=ÃÜÂë:
echo _______________________________________________________________________________
cls
...
echo _______________________________________________________________________________
set shanchuyonghu=
set/p shanchuyonghu=ÇëÊäÈëÒªÉ¾³ıµÄÓÃ»§:
cls
...
echo _______________________________________________________________________________
set/p tishengyonghu=
set/p tishengyonghu=ÇëÊäÈëÒªÌáÉıµÄÓÃ»§Ãû:
cls
...
set xiougaimima=
set xinmima=
set/p xiougaimima=ÇëÊäÈëÒªĞŞ¸ÄµÄÓÃ»§Ãû:
set/p xinmima=ÇëÊäÈëĞÂÃÜÂë:
cls
...
set/p chakanyonghuxinxi=ÇëÊäÈëÒª²é¿´µÄÓÃ»§Ãû:
cls
...
echo [5]¿ªÆôĞİÃß¹¦ÄÜ
echo [6]¹Ø±ÕĞİÃß¹¦ÄÜ
echo [7]ÏÔÊ¾ÏµÍ³ÉÏ¿ÉÓÃµÄË¯Ãß×´Ì¬
echo [8]ËøÆÁ
echo [9]Ñ­»·ÏÔÊ¾»½ĞÑ¼ÆÊ±Æ÷ÓëµçÔ´ÇëÇó
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 1234567890 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
title ¹Ø»ú - %system%
cls
echo ÇëÉèÖÃ¹Ø»úµ¹¼ÆÊ±£¬ÓĞĞ§·¶Î§(0-315360000)Ãë(e=·µ»Ø)
set guanjidaojishi=
...
title ÖØÆô - %system%
cls
echo ÇëÉèÖÃÖØÆôµ¹¼ÆÊ±£¬ÓĞĞ§·¶Î§(0-315360000)Ãë(e=·µ»Ø)
set chongqidaojishi=
...
goto guanji(3)
:guanji(4)
title ·ÅÆúÏµÍ³¹Ø»ú - %system%
cls
shutdown /a
ping/n 2 0.0>nul
goto guanji
:guanji(6)
title ¿ªÆôĞİÃß - %system%
cls
set size=
set/p size=ÉèÖÃĞİÃßÎÄ¼şÕ¼ÓÃ×ÜÄÚ´æ±ÈÀı(40~100)(Ä¬ÈÏ100)(e=·µ»Ø):
set size="%size:|=%"
...
goto guanji
:guanji(8)
title ÏÔÊ¾ÏµÍ³ÉÏ¿ÉÓÃµÄË¯Ãß×´Ì¬ - %system%
cls
powercfg -a
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
goto guanji
:guanji-9
title Ñ­»·ÏÔÊ¾»½ĞÑ¼ÆÊ±Æ÷ÓëµçÔ´ÇëÇó - %system%
cls
powercfg /requests
powercfg /waketimers
echo _______________________________________________________________________________
...
echo _______________________________________________________________________________
echo [1]ÏÔÊ¾ËùÓĞ½ø³Ì
echo [2]ÏÔÊ¾Ã¿¸ö½ø³ÌµÄ·şÎñ
echo [3]ÏÔÊ¾½ø³ÌÂ·¾¶
echo [4]ÏÔÊ¾½ø³ÌÏêÏ¸ĞÅÏ¢
echo [5]ÏÔÊ¾½ø³ÌµÄTCP/UDPÁ¬½Ó
...
echo (e=·µ»Ø)(f=Ë¢ĞÂ)
set jcjs=
set/p jcjs=ÊäÈëÒª½áÊøµÄ½ø³ÌPID»òÃû³Æ:
...
echo (e=·µ»Ø)(f=Ë¢ĞÂ)
set jcfw=
set/p jcfw=ÊäÈëÒª½áÊøµÄ½ø³ÌPID»òÃû³Æ:
...
echo (e=·µ»Ø)(f=Ë¢ĞÂ)
set jcxq=
set/p jcxq=ÇëÊäÈëÒªÏÔÊ¾µÄ½ø³ÌµÄPID:
if not defined jcxq goto 23(10)
set jcxq="%jcxq:|=%"
if /i !jcxq!=="e" goto 23
if /i !jcxq!=="f" goto 23(10)
tasklist /fi "pid eq %jcxq%"|findstr /i "%jcxq%"||echo Ã»ÓĞ´Ë½ø³Ì&&timeout /t 2 /nobreak>nul&&goto 23(10)
cls
echo _______________________________________________________________________________
set jcmz=
...
echo ½ø³ÌÃüÁîĞĞ:		!jcmlh:~12!
set jcrq=
for /f "delims=" %%a in ('"wmic process where processid=!jcxq! get /format:value|find /i "creationdate""') do set jcrq=%%a
echo ½ø³ÌÆô¶¯ÈÕÆÚ:		!jcrq:~13,4!Äê!jcrq:~17,2!ÔÂ!jcrq:~19,2!ÈÕ !jcrq:~21,2!:!jcrq:~23,2!:!jcrq:~25,2!
set jclj=
set jclj1=
...
echo (e=·µ»Ø)(f=Ë¢ĞÂ)
set ×Ö·û´®=
set /p ×Ö·û´®=ÊäÈëÒª²éÕÒµÄ×Ö·û´®: 
if not defined ×Ö·û´® (goto 23.1)
if "!×Ö·û´®!" equ "e" (goto 23)
if "!×Ö·û´®!" equ "f" (goto 23.1)
cls
netstat -aon|findstr /i /c:"!×Ö·û´®!"
echo _______________________________________________________________________________
set /p =°´ÈÎÒâ¼ü·µ»Ø<nul&pause>nul
goto 23
:23-1
color 0f
set ysbak=97;40m
...
echo;!netcard!
echo;
(echo;ÉÏ´«ËÙ¶È:  !upspeed!/s ÏÂÔØËÙ¶È:   !downspeed!/s   	)
echo;
echo;!cpu!
echo;
set /p =CPU×ÜÌåÀûÓÃÂÊ:  <nul
if !lyl! leq 25 (
...
:24
title ÎÄ¼şÏµÍ³ĞÅÏ¢²éÑ¯ - %system%
cls
echo _______________________________________________________________________________
echo [1]ÁĞ³öËùÓĞÇı¶¯Æ÷
echo [2]²éÑ¯Ò»¸öÇı¶¯Æ÷µÄÀàĞÍ
echo [3]²éÑ¯¾íĞÅÏ¢
echo [4]²éÑ¯NTFS¾íĞÅÏ¢
echo [5]²éÑ¯REFS¾íĞÅÏ¢
echo [6]²éÑ¯ÉÈÇøĞÅÏ¢
...
goto 24
:24(2)
title ²éÑ¯Ò»¸öÇı¶¯Æ÷µÄÀàĞÍ - %system%
cls
echo _______________________________________________________________________________
fsutil fsinfo drives
echo _______________________________________________________________________________
set qdqlx=
set/p qdqlx=ÇëÊäÈëÒª²éÑ¯µÄÇı¶¯Æ÷:
cls
...
goto 24
:24(3)
title ²éÑ¯¾íĞÅÏ¢ - %system%
cls
echo _______________________________________________________________________________
fsutil fsinfo drives
echo _______________________________________________________________________________
set juanxx=
set/p juanxx=ÇëÊäÈëÒª²éÑ¯µÄÇı¶¯Æ÷:
cls
...
goto 24
:24(4)
title ²éÑ¯NTFS¾íĞÅÏ¢ - %system%
cls
echo _______________________________________________________________________________
fsutil fsinfo drives
echo _______________________________________________________________________________
set ntfsjxx=
set/p ntfsjxx=ÇëÊäÈëÒª²éÑ¯µÄÇı¶¯Æ÷:
cls
...
goto 24
:25
title ´´½¨Ö¸¶¨´óĞ¡µÄÎÄ¼ş - %system%
cls
echo ´´½¨Ö¸¶¨´óĞ¡µÄÎÄ¼ş(e=·µ»Ø)
echo _______________________________________________________________________________
set cjlj=
...
goto 25
:26
title ÃâÒßUÅÌ²¡¶¾ - %system%
cls
echo ´Ë¹¦ÄÜÕë¶ÔUÅÌ½øĞĞÃâÒß£¬±ÜÃâautorunÀàĞÍµÄ²¡¶¾×Ô¶¯Æô¶¯
echo _______________________________________________________________________________
echo [1]Æô¶¯UÅÌÃâÒß
echo [2]È¡ÏûUÅÌÃâÒß
echo [0]·µ»Ø²Ëµ¥
...
goto 26
:26(1)
title Æô¶¯UÅÌÃâÒß - %system%
cls
echo ÕıÔÚËÑË÷¿ÉÒÆ¶¯´ÅÅÌ...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for %%l in (%sypf%) do (
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&goto 26-3)
cls
echo Ã»ÓĞÕÒµ½¿ÉÒÆ¶¯´ÅÅÌ
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
...
set sypf=%sypf:~5%
for %%l in (%sypf%) do (
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&takeown/f %%lautorun.inf
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&echo y|cacls %%lautorun.inf /t /c /p everyone:f
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&attrib -s -h -r %%lautorun.inf
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&del/f/q %%lautorun.inf
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&rd/s/q %%lautorun.inf
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&md %%lautorun.inf
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&md "%%lautorun.inf\ÃâÒßÎÄ¼ş¼Ğ£¡ÇëÎğÉ¾³ı"
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&md "%%lautorun.inf\ÃâÒßÎÄ¼ş¼Ğ£¡ÇëÎğÉ¾³ı / "
fsutil fsinfo drivetype %%l|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&echo y|cacls %%lautorun.inf /t /c /p everyone:r) 2>nul
echo;
echo _______________________________________________________________________________
echo UÅÌÃâÒßÍê³É
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
goto 26
:26(2)
title È¡ÏûUÅÌÃâÒß - %system%
cls
echo ÕıÔÚËÑË÷¿ÉÒÆ¶¯´ÅÅÌ...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for %%m in (%sypf%) do (
fsutil fsinfo drivetype %%m|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&goto 26-4)
cls
echo Ã»ÓĞÕÒµ½¿ÉÒÆ¶¯´ÅÅÌ
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
...
set sypf=%sypf:~5%
for %%m in (%sypf%) do (
fsutil fsinfo drivetype %%m|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&takeown/f %%mautorun.inf
fsutil fsinfo drivetype %%m|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&echo y|cacls %%mautorun.inf /t /c /p everyone:f
fsutil fsinfo drivetype %%m|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&attrib -s -h -r %%mautorun.inf
fsutil fsinfo drivetype %%m|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&del/f/q %%mautorun.inf
fsutil fsinfo drivetype %%m|find /i "¿ÉÒÆ¶¯Çı¶¯Æ÷"&&rd/s/q %%mautorun.inf) 2>nul
echo _______________________________________________________________________________
echo È¡ÏûUÅÌÃâÒßÍê³É
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
goto 26
:27
title ´ÅÅÌËéÆ¬ÕûÀí - %system%
cls
echo _______________________________________________________________________________
echo [1]ÕûÀíËùÓĞ´ÅÅÌ
echo [0]·µ»Ø²Ëµ¥
...
:27(3)
set zhengli=
set/p zhengli=ÊÇ·ñ¿ªÊ¼´ÅÅÌËéÆ¬ÇåÀí(y/n):
set zhengli="%zhengli:|=%"
...
goto 27
:28
title Ò»¼üÉ¾³ı¿ÕÎÄ¼ş¼Ğ - %system%
cls
echo ¼ì²âEverythingµÄ°²×°Â·¾¶ÓëÔËĞĞ×´Ì¬...
set flag=
set flag1=::
...
cls
echo ×¢Òâ:Èç¹û¶ÔÏµÍ³ÅÌ½øĞĞ²Ù×÷¿ÉÄÜ»á±»É±¶¾Èí¼şÀ¹½Ø
echo _______________________________________________________________________________
fsutil fsinfo drives
echo _______________________________________________________________________________
set caozuo=
set/p caozuo=ÇëÊäÈëĞèÒª²Ù×÷µÄÅÌ·û»òÂ·¾¶:
if not defined caozuo goto 28
set caozuo|findstr /i "\<[a-z]\>">nul
if "%errorlevel%" neq "0" goto 28-1
cls
echo ÕıÔÚËÑË÷¿ÕÎÄ¼ş¼Ğ...     ÎÄ¼şÔ½¶àËÑË÷Ê±¼äÔ½³¤
%flag%for /f "delims=" %%o in ('"dir/a/s/b/ad-l %caozuo%:|sort/r"') do rd/q "%%o"2>nul&&echo ÒÑÉ¾³ı¿ÕÎÄ¼ş¼Ğ%%o
::%flag1%for /f "delims=" %%o in ('""%EverythingInstallPath%\es.exe" -sort path-descending /ad-l %caozuo%:"') do rd/q "%%o"2>nul&&echo ÒÑÉ¾³ı¿ÕÎÄ¼ş¼Ğ%%o
:loop1
%flag1%set empty=0
%flag1%for /f "delims=" %%o in ('""%EverythingInstallPath%\es.exe" %caozuo%: empty: ^!attrib:l"') do (rd/q "%%o"2>nul&&set empty=1&&echo ÒÑÉ¾³ı¿ÕÎÄ¼ş¼Ğ%%o)
timeout /t 2 /nobreak>nul
%flag1%if "%empty%"=="1" goto loop1
goto 28(2)
:28-1
dir /ad "!caozuo!">nul 2>nul||echo Â·¾¶ !caozuo! ²»ÊÇÒ»¸öÎÄ¼ş¼Ğ&&timeout /t 2 /nobreak>nul&&goto 28
echo ÕıÔÚËÑË÷¿ÕÎÄ¼ş¼Ğ...     ÎÄ¼şÔ½¶àËÑË÷Ê±¼äÔ½³¤
...
set ping=
set pingcishu=
if exist %systemroot%\system32\curl.exe (ping /n 1 www.baidu.com>nul&if !errorlevel! equ 0 (rem set /p =±¾»úIPV4µØÖ·: <nul
rem curl 4.ipw.cn
rem curl ipv4.ip.sb
...
for /f "skip=2 tokens=2 delims==" %%a in ('Wmic OS Get LastBootUpTime /value') do (
    ...
    echo;ÏµÍ³Æô¶¯Ê±¼ä:	!systemstarttime:~0,4!Äê!systemstarttime:~4,2!ÔÂ!systemstarttime:~6,2!ÈÕ !systemstarttime:~8,2!:!systemstarttime:~10,2!:!systemstarttime:~12,2!
    echo;
)
set systeminstalltime=
for /f "skip=2 tokens=2 delims==" %%a in ('Wmic OS Get InstallDate /value') do (
    set systeminstalltime=%%a
    echo;ÏµÍ³°²×°ÈÕÆÚ:	!systeminstalltime:~0,4!Äê!systeminstalltime:~4,2!ÔÂ!systeminstalltime:~6,2!ÈÕ !systeminstalltime:~8,2!:!systeminstalltime:~10,2!:!systeminstalltime:~12,2!
    echo;
)
...
echo ·Ö±æÂÊ: 	%fbl1% x %fbl2%
echo _______________________________________________________________________________
set xkxc=,xsms=,sxl=,qdrq=,qdbb=
set /p =ÏÔ¿¨: 		<nul&for /f "delims=" %%a in ('"wmic path win32_videocontroller get name|find /i /v "name""') do echo %%a|find /i /v "echo"
...
echo Çı¶¯ÈÕÆÚ: 	%qdrq:~0,4%Äê%qdrq:~4,2%ÔÂ%qdrq:~6,2%ÈÕ
echo;
...
for /f "skip=2 tokens=2 delims==" %%a in ('Wmic path Win32_PerfFormattedData_Tcpip_NetworkInterface get CurrentBandwidth /value') do (
    ...
    echo;µ±Ç°ÍøÂçÁ¬½ÓËÙ¶È:      !netspeed! Mbps
    echo;
)
echo Íø¹ØµØÖ·:
...
title ¶ÁĞÄÊõ - %system%
cls
echo ÏëÒ»¸ö´óÓÚ0ÇÒĞ¡ÓÚ128µÄÊı(²»°üÀ¨128)
echo _______________________________________________________________________________
pause
cls
:d0c
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[1\7]
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[2\7]
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[3\7]
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[4\7]
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[5\7]
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[6\7]
...
echo;
choice /c YN /n /m ÇëÎÊÕâÀïÓĞÄãÏëµÄÊıÂğ?(Y=ÓĞ,N=Ã»ÓĞ)[7\7]
...
echo [1]¶¨Ê±ÌáĞÑÖ¸¶¨ÄÚÈİ
echo [2]¶¨Ê±ÔËĞĞÖ¸¶¨ÎÄ¼ş
echo [3]ÏÔÊ¾ÒÑÓĞµÄ¼Æ»®ÈÎÎñ
echo [4]É¾³ı¼Æ»®ÈÎÎñ
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
set nzxx=
set/p nzxx=ÇëÊäÈëÄãµÄÑ¡Ôñ:
set nzxx="%nzxx:|=%"
if !nzxx!=="1" goto 32(1)
if !nzxx!=="2" goto 32(2)
if !nzxx!=="3" goto 32(3)
...
goto 32
:32(1)
title ¶¨Ê±ÌáĞÑÖ¸¶¨ÄÚÈİ - %system%
cls
set txnrmc=
set/p txnrmc=ÇëÖ¸¶¨ÈÎÎñÃû³Æ:
echo _______________________________________________________________________________
set txnr=
set/p txnr=ÇëÊäÈëÄãĞèÒªÌáĞÑµÄÄÚÈİ:
echo _______________________________________________________________________________
set txnrrq=
set/p txnrrq=ÇëÉèÖÃÌáĞÑÈÕÆÚ(¸ñÊ½: yyyy/mm/dd ÀıÈç2015/08/05):
echo _______________________________________________________________________________
set txnrsj=
set/p txnrsj=ÇëÉèÖÃÌáĞÑÊ±¼ä(¸ñÊ½: hh:mm:ss ÀıÈç09:03:05):
cls
md %systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼>nul 2>nul
echo ¸ÃÎÄ¼ş¼ĞÊÇDOS¹¤¾ßÏäµÄÁÙÊ±ÎÄ¼ş¼Ğ,É¾³ıºó½«ÎŞ·¨ÌáĞÑÒÑÓĞµÄÄÚÈİ£¡>%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\ËµÃ÷.txt
echo @echo off>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo title %txnrmc%>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo color f1>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo >>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo cls>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo ÌáĞÑÄÚÈİ:"%txnr%">>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo _______________________________________________________________________________>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo ¸ÃÎÄ¼şÓÉDOS¹¤¾ßÏä - ¶¨Ê±ÌáĞÑÖ¸¶¨ÄÚÈİ¹¦ÄÜÉú³É>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo Éú³ÉÊ±¼ä:%date:~0,4%Äê%date:~5,2%ÔÂ%date:~8,2%ÈÕ %xingqi% %time:~0,8%>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo _______________________________________________________________________________>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo echo °´ÈÎÒâ¼üÍË³ö^&pause^>nul>>"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
schtasks /create /tn "%txnrmc%" /tr "%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat" /st %txnrsj% /sd %txnrrq% /sc once&&echo ÈÎÎñ½«ÔÚ%txnrrq% %txnrsj%ÔËĞĞ
echo ÌáĞÑÎÄ¼şÒÑ±£´æÖÁ"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%txnrmc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto 32
:32(2)
title ¶¨Ê±ÔËĞĞÖ¸¶¨ÎÄ¼ş - %system%
cls
set dsyxmc=
set/p dsyxmc=ÇëÖ¸¶¨ÈÎÎñÃû³Æ:
echo _______________________________________________________________________________
set dsyxlj=
set/p dsyxlj=ÇëÍÏ¶¯ĞèÒª¶¨Ê±ÔËĞĞµÄÎÄ¼şµ½´Ë´°¿Ú:
if "%dsyxlj:~0,1%%dsyxlj:~-1%" neq """" for /f "delims=" %%a in ('"echo %dsyxlj%"') do (set %dsyxlj%="%%~a")
echo _______________________________________________________________________________
set dsyxrq=
set/p dsyxrq=ÇëÉèÖÃÌáĞÑÈÕÆÚ(¸ñÊ½: yyyy/mm/dd ÀıÈç2015/08/05):
echo _______________________________________________________________________________
set dsyxsj=
set/p dsyxsj=ÇëÉèÖÃÌáĞÑÊ±¼ä(¸ñÊ½: hh:mm:ss ÀıÈç09:03:05):
cls
md %systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼>nul 2>nul
echo ¸ÃÎÄ¼ş¼ĞÊÇDOS¹¤¾ßÏäµÄÁÙÊ±ÎÄ¼ş¼Ğ,É¾³ıºó½«ÎŞ·¨ÌáĞÑÒÑÓĞµÄÄÚÈİ£¡>%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\ËµÃ÷.txt
echo "%dsyxlj%">"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%dsyxmc% - ¶¨Ê±ÔËĞĞÎÄ¼ş.bat"
schtasks /create /tn "%dsyxmc%" /tr "%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%dsyxmc% - ¶¨Ê±ÔËĞĞÎÄ¼ş.bat" /st %dsyxsj% /sd %dsyxrq% /sc once&&echo ÈÎÎñ½«ÔÚ%dsyxrq% %dsyxsj%ÔËĞĞ
echo Æô¶¯ÎÄ¼şÒÑ±£´æÖÁ"%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%dsyxmc% - ¶¨Ê±ÔËĞĞÎÄ¼ş.bat"
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto 32
:32(3)
title ÏÔÊ¾ÒÑÓĞµÄ¼Æ»®ÈÎÎñ - %system%
cls
schtasks /query
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto 32
:32(4)
title É¾³ı¼Æ»®ÈÎÎñ - %system%
cls
schtasks /query
echo _______________________________________________________________________________
set rwsc=
set/p rwsc=ÇëÊäÈëÒªÉ¾³ıµÄÈÎÎñÃû³Æ:
cls
schtasks /delete /tn "%rwsc%" /f
del/f/q "%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%rwsc% - ¶¨Ê±ÌáĞÑÎÄ¼ş.bat"2>nul
del/f/q "%systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\%rwsc% - ¶¨Ê±ÔËĞĞÎÄ¼ş.bat"2>nul
dir/a/s %systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼\*.bat>nul 2>nul||rd/s/q %systemdrive%\DOS¹¤¾ßÏäÁÙÊ±Ä¿Â¼
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto 32
:33
...
echo ¼ÆÊ±Æ÷¾«È·¶È0.01Ãë
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü¿ªÊ¼¼ÆÊ±(²»½¨Òé¿çÌì¼ÆÊ±)&pause>nul
set kssjbk=%time%
cls
echo ¼ÆÊ±Æ÷ÒÑ¿ªÊ¼¼ÆÊ±,°´ÈÎÒâ¼üÍ£Ö¹¼ÆÊ±.&pause>nul
set jssjbk=%time%
call :sjc "%kssjbk%" "%jssjbk%"
cls
echo ¼ÆÊ±¿ªÊ¼Ê±¼ä:%kssjbk%
echo ¼ÆÊ±½áÊøÊ±¼ä:%jssjbk%
echo _______________________________________________________________________________
...
cls
echo °´ÈÎÒâ¼ü¿ªÊ¼É¾³ıSystem Volume InformationÎÄ¼ş¼Ğ&pause>nul
cls
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
for %%a in (%sypf%) do (
...
set bajinzhi=
cls
echo ×î´óÖ§³Ö2147483647µÄÊ®½øÖÆ×ª»»
echo _______________________________________________________________________________
echo [1]ÊäÈëÊ®½øÖÆ×ª»»
echo [2]ÊäÈë¶ş½øÖÆ×ª»»
echo [0]·µ»Ø²Ëµ¥
...
cls
set shijinzhi=
set/p shijinzhi=ÇëÊäÈëÊ®½øÖÆÕûÊı:
...
cls
echo Ê®½øÖÆ:%shijinzhibak2%
echo ¶ş½øÖÆ:%erjinzhi%
echo °Ë½øÖÆ:%bajinzhi%
echo Ê®Áù½øÖÆ:%shilioujinzhi%
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
goto 36
:shijinzhicw
...
:guanyu
setlocal enabledelayedexpansion
title ¹ØÓÚDOS¹¤¾ßÏä - %system%%gxflag%
if %daxiao%==%versize% set daxiao1=%daxiao%×Ö½Ú
if %daxiao% neq %versize% set daxiao1=%daxiao%×Ö½Ú  (ÎÄ¼ş´óĞ¡Òì³£,¿ÉÄÜÒÑ±»ĞŞ¸Ä)
set dosjssj=%time%
...
cls
echo _______________________________________________________________________________
echo ÒªÏÔÊ¾¶à¸öÎÄ¼ş,¾ÍÓÃ¿Õ¸ñ¸ô¿ªÂ·¾¶,ÏÔÊ¾ÎÄ¼şÒÔºó:
echo F=ÏÔÊ¾ÏÂ¸öÎÄ¼ş,Q=ÍË³ö,µÈºÅÏÔÊ¾ĞĞÊı,¿Õ¸ñÏÔÊ¾ÏÂÒ»Ò³,»Ø³µÏÔÊ¾ÏÂÒ»ĞĞ
echo _______________________________________________________________________________
set wenben=
set/p wenben=ÍÏ¶¯ĞèÒªÏÔÊ¾µÄÎÄ¼şµ½´Ë´°¿Ú:
...
cls
echo ´Ë¹¦ÄÜÖ»ÄÜÓÃÓÚNTFS·ÖÇø,ÒªÑ¹Ëõ»òÕß½âÑ¹¶à¸öÎÄ¼ş,¾ÍÓÃ¿Õ¸ñ¸ô¿ªÂ·¾¶.
echo _______________________________________________________________________________
echo [1]NTFSÑ¹Ëõ
echo [2]NTFS½âÑ¹
echo [3]NTFSÑ¹ËõÎÄ¼ş¼Ğ
echo [4]NTFS½âÑ¹ÎÄ¼ş¼Ğ
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 12340 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
goto 39
:jieya
title NTFS½âÑ¹ - %system%
cls
set jieya=
set/p jieya=ÍÏ¶¯ĞèÒª½âÑ¹µÄÎÄ¼şµ½´Ë´°¿Ú:
...
cls
set yasuo=
set/p yasuo=ÍÏ¶¯ĞèÒªÑ¹ËõµÄÎÄ¼şµ½´Ë´°¿Ú:
...
goto 39
:jieyawjj
title NTFS½âÑ¹ÎÄ¼ş¼Ğ - %system%
cls
set jieya=
set/p jieya=ÍÏ¶¯ĞèÒª½âÑ¹µÄÎÄ¼ş¼Ğµ½´Ë´°¿Ú:
...
goto 39
:yasuowjj
title NTFSÑ¹ËõÎÄ¼ş¼Ğ - %system%
cls
set jieya=
set/p jieya=ÍÏ¶¯ĞèÒªÑ¹ËõµÄÎÄ¼ş¼Ğµ½´Ë´°¿Ú:
if "%jieya:~0,1%%jieya:~-1%" neq """" for /f "delims=" %%a in ('"echo %jieya%"') do (set %jieya%="%%~a")
echo _______________________________________________________________________________
...
goto 39
:40
title »ñÈ¡ÎÄ¼şËùÓĞÈ¨ÏŞ - %system%
cls
echo ´Ë¹¦ÄÜÖ»ÄÜÓÃÓÚNTFS·ÖÇø
echo _______________________________________________________________________________
set ntfswjqx=
set/p ntfswjqx=ÍÏ¶¯ĞèÒª»ñÈ¡ËùÓĞÈ¨ÏŞµÄÎÄ¼ş»òÕßÎÄ¼ş¼Ğµ½´Ë´°¿Ú:
...
cls
echo _______________________________________________________________________________
if /i "%system:~18,1%"=="x" dir/a/s/b "%systemdrive%\Documents and Settings\%username%\¡¸¿ªÊ¼¡¹²Ëµ¥\³ÌĞò\Æô¶¯"
if /i "%system:~18,1%"=="x" dir/a/s/b "%systemdrive%\Documents and Settings\all users\¡¸¿ªÊ¼¡¹²Ëµ¥\³ÌĞò\Æô¶¯"
...
cls
set batfx=
set/p batfx=ÍÏ¶¯Òª·ÖÎöµÄÎÄ¼şµ½´Ë´°¿Ú:
...
cls
set sswjm=
set/p sswjm=ÊäÈëÄãÒªËÑË÷µÄÎÄ¼şÃû(Ä¬ÈÏÔÚ%systemdrive%\ÖĞËÑË÷):
echo _______________________________________________________________________________
dir/a/s %sswjm%
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
...
cls
set xfwj=
set/p xfwj=ÍÏ¶¯ÒªĞŞ¸´µÄÎÄ¼şµ½´Ë´°¿Ú:
...
md %systemdrive%windows\temp\DOS¹¤¾ßÏäÁÙÊ±½âÑ¹Â·¾¶
for /f "delims=" %%a in ('type "%pjzd%"') do (
cls
echo ÕıÔÚÆÆ½âµÄÑ¹Ëõ°ü:%yswjlj%
echo;
echo ÕıÔÚÊ¹ÓÃµÄ×ÖµäÎÄ¼ş:%pjzd%
echo;
set pjmm=%%a
echo ÕıÔÚ³¢ÊÔÃÜÂë:%%a
"%rarpd%" x -y -inul -p%%a "%yswjlj%" "%systemdrive%windows\temp\DOS¹¤¾ßÏäÁÙÊ±½âÑ¹Â·¾¶"
dir/s/b %systemdrive%windows\temp\DOS¹¤¾ßÏäÁÙÊ±½âÑ¹Â·¾¶|find  /v "ÕÒ²»µ½ÎÄ¼ş"&&goto pjcg)
echo _______________________________________________________________________________
echo ÆÆ½âÊ§°Ü£¡
echo;
...
set pjmm=%%a
echo ÕıÔÚ³¢ÊÔÃÜÂë:%%a
"%rarpd7z%" x -y -inul -p%%a "%yswjlj%" "%systemdrive%windows\temp\DOS¹¤¾ßÏäÁÙÊ±½âÑ¹Â·¾¶"
dir/s/b %systemdrive%windows\temp\DOS¹¤¾ßÏäÁÙÊ±½âÑ¹Â·¾¶|find  /v "ÕÒ²»µ½ÎÄ¼ş"&&goto pjcg1)
echo _______________________________________________________________________________
echo ÆÆ½âÊ§°Ü£¡
echo;
echo ×ÖµäÀïÃ»ÓĞÕıÈ·µÄÃÜÂë.
...
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 1230 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
goto 47
:kqwifi
title ¿ªÆôWifiÈÈµã - %system%
cls
set wifissid=
set wifimiam=
set/p wifissid=ÇëÊäÈëWifiÃû³Æ(SSID):
set/p wifimima=ÇëÊäÈëWifiÃÜÂë(ÃÜÂëÎ»Êı:8µ½63Î»):
cls
...
echo _______________________________________________________________________________
echo Èç¹ûÎŞ·¨Á¬½ÓÇëÊÖ¶¯»ñÈ¡IPµØÖ·(Èç¹û¿ªÆôÏµÍ³·À»ğÇ½Ò²»áÎŞ·¨Á¬½Ó³É¹¦)
echo WifiÃû³Æ(SSID):%wifissid%
echo WifiÃÜÂë:%wifimima%
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
goto 47
:gbwifi
title ¹Ø±ÕWifiÈÈµã - %system%
cls
netsh wlan stop hostednetwork
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
...
goto xz
:xzgjx
reg delete HKEY_CURRENT_USER\System\DOS¹¤¾ßÏä /f>nul 2>nul
rd/s/q %systemdrive%\dos¹¤¾ßÏäÁÙÊ±Ä¿Â¼>nul 2>nul
cls
echo Ğ¶ÔØ³É¹¦
ping/n 2 0.0>nul
...
cls
echo ÍÏ¶¯Òª±È½ÏµÄÎÄ¼şµ½´Ë´°¿Ú(±È½Ï¹ı³ÌÖĞÁ¬°´ "Ctrl+C" 2´Î¿É½áÊø±È½Ï)
echo _______________________________________________________________________________
set/p wj1=µÚÒ»¸öÒª±È½ÏµÄÎÄ¼ş:
set/p wj2=µÚ¶ş¸öÒª±È½ÏµÄÎÄ¼ş:
echo _______________________________________________________________________________
fc/b %wj1% %wj2%
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
...
set nz=
cls
set/p  nz=ÇëÊäÈëÒªĞ´Èëµ½¼ôÇĞ°åµÄÎÄ×ÖÄÚÈİ:
...
set/a rn3=%y%%%400
set rn=Æ½Äê
if %rn1%==0 if %rn2% neq 0 set rn=ÈòÄê
if %rn2%==0 if %rn3%==0 set rn=ÈòÄê
if %w%==1 set w=Ò»
if %w%==2 set w=¶ş
if %w%==3 set w=Èı
if %w%==4 set w=ËÄ
...
echo ²Ù×÷ÏµÍ³: %system% %bit%Î»
if "!system:~8,2!"=="XP" echo Windows XPÏµÍ³ÎŞ·¨Ê¹ÓÃ´Ë¹¦ÄÜ²éÑ¯
echo _______________________________________________________________________________
echo [1]ÏÔÊ¾Ğí¿ÉĞÅÏ¢
echo [2]ÏÔÊ¾ÏêÏ¸µÄĞí¿ÉĞÅÏ¢
echo [3]ÏÔÊ¾µ±Ç°Ğí¿É×´Ì¬µÄ½ØÖ¹ÈÕÆÚ
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 1230 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
:55
cls
title ´´½¨Ö¸¶¨ÎÄ¼şµÄ¿ì½İ·½Ê½µ½×ÀÃæ - %system%
set kjfs=
set/p kjfs=ÇëÍÏ¶¯Ä¿±êÎÄ¼şµ½´Ë´°¿Ú:
if "!kjfs!"=="" goto 55(1)
...
set swjj=
set cwjj=
set/p swjj=ÊäÈëÒªÁ´½ÓµÄÎÄ¼ş¼ĞÂ·¾¶:
set/p cwjj=ÊäÈëÁ´½ÓÎÄ¼ş¼ĞµÄÊä³öÂ·¾¶:
...
echo _______________________________________________________________________________
echo [1]ÁĞ³ö¾í×°Èëµã
echo [2]É¾³ı²»ÔÚÏµÍ³ÖĞµÄ¡¢¾íµÄ×°ÈëµãÄ¿Â¼ºÍ×¢²á±íÉèÖÃ
echo [3]ÁĞ³öÖ¸¶¨Ä¿Â¼µÄÒÑ×°ÈëµÄ¾íÃû³Æ
echo [4]´´½¨ÅÌ·û(´´½¨¾í×°Èëµã)
echo [5]É¾³ıÅÌ·û(É¾³ı¾í×°Èëµã)
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 123450 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
goto 61
:61(2)
title É¾³ı²»ÔÚÏµÍ³ÖĞµÄ,¾íµÄ×°ÈëµãÄ¿Â¼ºÍ×¢²á±íÉèÖÃ - %system%
cls
mountvol /r
echo ²Ù×÷Íê³É
echo _______________________________________________________________________________
...
goto 61
:61(3)
title ÁĞ³öÖ¸¶¨Ä¿Â¼µÄÒÑ×°ÈëµÄ¾íÃû³Æ - %system%
cls
fsutil fsinfo drives
echo _______________________________________________________________________________
set xszz=
set/p xszz=ÇëÊäÈëĞèÒªÏÔÊ¾µÄÅÌ·û:
cls
...
goto 61
:61(5)
title É¾³ıÅÌ·û(É¾³ı¾í×°Èëµã) - %system%
cls
fsutil fsinfo drives
echo _______________________________________________________________________________
set scpf=
set/p scpf=ÇëÊäÈëĞèÒªÉ¾³ıµÄÅÌ·û:
mountvol %scpf%: /d
echo ²Ù×÷Íê³É
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø&pause>nul
...
cls
set zcbss=
set/p zcbss=ÊäÈëÄãÒªËÑË÷µÄÃû³Æ:
set zcbss="%zcbss:|=%"
echo _______________________________________________________________________________
echo (1/5)ÔÚHKEY_CLASSES_ROOTÖĞËÑË÷...
reg query hkcr /f !zcbss! /s
echo _______________________________________________________________________________
echo (2/5)ÔÚHKEY_CURRENT_USERÖĞËÑË÷...
reg query hkcu /f !zcbss! /s
echo _______________________________________________________________________________
echo (3/5)ÔÚHKEY_LOCAL_MACHINEÖĞËÑË÷...
reg query hklm /f !zcbss! /s
echo _______________________________________________________________________________
echo (4/5)ÔÚHKEY_USERSÖĞËÑË÷...
reg query hku /f !zcbss! /s
echo _______________________________________________________________________________
echo (5/5)ÔÚHKEY_CURRENT_CONFIGÖĞËÑË÷...
...
title Base½âÂë - %system%
set basebm=
set/p basebm=ÊäÈëÒª½âÂëµÄ×Ö·û´®»òÎÄ¼şÂ·¾¶:
if "!basebm!"=="" goto 63-1
...
dir/ad "!basebm!" >nul 2>nul&&echo ²»ÄÜ½âÂëÎÄ¼ş¼Ğ||goto 63-12
ping/n 2 0.0>nul
goto 63-1
:63-12
...
cls
echo _______________________________________________________________________________
echo ÊäÈëÄÚÈİ: !basebm!
echo ½âÂëÄÚÈİ:
if exist %temp%\codetmp (for /f "delims=" %%a in (%temp%\codetmp) do (if "%%a" neq "-----BEGIN CERTIFICATE-----" (if "%%a" neq "-----END CERTIFICATE-----" (echo %%a)))) else (echo ½âÂëÊ§°Ü)
echo _______________________________________________________________________________
set bxz=
set/p bxz=ÊäÈë"y"±£´æ±àÂë,ÆäËûÊäÈë·µ»ØÉÏ¼¶²Ëµ¥:
set bxz="%bxz:|=%"
if !bxz!=="y" goto 63(1)(2)
goto 63
:63(1)(2)
set basebc=
set/p basebc=ÊäÈë±£´æÂ·¾¶:
echo _______________________________________________________________________________
copy/y/z %temp%\codetmp !basebc!
if %errorlevel% neq 0 (echo ±£´æÊ§°Ü) else (echo ±£´æ³É¹¦)
echo _______________________________________________________________________________
echo °´ÈÎÒâ¼ü·µ»Ø²Ëµ¥&pause>nul
goto 63
:63-2
cls
del/f/q %temp%\codetmp>nul 2>nul
title Base±àÂë - %system%
set basebm=
set/p basebm=ÊäÈëÒª±àÂëµÄ×Ö·û´®»òÎÄ¼şÂ·¾¶:
if "!basebm!"=="" goto 63-2
if not exist "!basebm!" (set /p =!basebm!<nul>%temp%\tmp
certutil -encode -f %temp%\tmp %temp%\codetmp>nul&goto 63-21)
if "!basebm:~0,1!!basebm:~-1!" neq """" for /f "delims=" %%a in ('"echo !basebm!"') do (set !basebm!="%%~a")
dir/ad "!basebm!" >nul 2>nul&&echo ²»ÄÜ±àÂëÎÄ¼ş¼Ğ||goto 63-22
ping/n 2 0.0>nul
goto 63-2
:63-22
...
goto 63
:64
title 8.3¶ÌÎÄ¼şÃû¹ÜÀí - %system%
cls
echo _______________________________________________________________________________
echo [1]²éÑ¯8.3¶ÌÎÄ¼şÃû×´Ì¬
echo [2]½ûÖ¹8.3¶ÌÎÄ¼şÃû´´½¨
echo [0]·µ»Ø²Ëµ¥
echo _______________________________________________________________________________
choice /c 120 /n /m ÇëÊäÈëÄãµÄÑ¡Ôñ:
...
fsutil fsinfo drives
set query83=
set/p query83=ÇëÊäÈëÒª²éÑ¯µÄÅÌ·û:
...
goto 64
:65
title ÖÇÄÜNTFSÑ¹Ëõ - %system%
cls
set url=
set/p url=ÇëÊäÈëÒªÑ¹ËõµÄÎÄ¼ş¼Ğ:
set url="%url:|=%"
dir /ad !url!>nul 2>nul||echo Â·¾¶ !url! ²»ÊÇÒ»¸öÎÄ¼ş¼Ğ&&timeout /t 2 /nobreak>nul&&goto 65
(
...
cls
echo »Æ½ğXAU    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !autocny!
echo;
echo °×ÒøXAG    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !agtocny!
echo;
echo ÒÔÌ«·»ETH  ¡ú ÈËÃñ±ÒCNY
set /p =.!cswz1!        <nul
set /p =1  ¡ú !ethtocny!		24Ğ¡Ê±ÕÇµø·ù: <nul
if "%eth24h:~0,1%" equ "-" (call :colortxt a !eth24h!) else (call :colortxt c +!eth24h!)
set /p =%% <nul
echo;
echo;
echo ±ÈÌØ±ÒBTC  ¡ú ÈËÃñ±ÒCNY
set /p =.!cswz1!        <nul
set /p =1  ¡ú !btctocny!		24Ğ¡Ê±ÕÇµø·ù: <nul
if "%btc24h:~0,1%" equ "-" (call :colortxt a !btc24h!) else (call :colortxt c +!btc24h!)
set /p =%% <nul
echo;
echo;
echo ÃÅÂŞ±ÒXMR  ¡ú ÈËÃñ±ÒCNY
set /p =.!cswz1!        <nul
...
echo;
echo;
echo ¹·¹·±ÒDOGE ¡ú ÈËÃñ±ÒCNY
set /p =.!cswz1!        <nul
set /p =1  ¡ú !dogetocny!		24Ğ¡Ê±ÕÇµø·ù: <nul
if "%doge24h:~0,1%" equ "-" (call :colortxt a !doge24h!) else (call :colortxt c +!doge24h!)
set /p =%% <nul
echo;
echo;
echo ÃÀÔªUSD    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !usdtocny!
echo;
echo Å·ÔªEUR    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !eurtocny!
echo;
echo Ó¢°÷GBP    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !gbptocny!
echo;
echo ÈÕÔªJPY    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !jpytocny!
echo;
echo ¸Û±ÒHKD    ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !hkdtocny!
echo;
echo ĞÂÌ¨±ÒTWD  ¡ú ÈËÃñ±ÒCNY
echo 	1  ¡ú !twdtocny!
echo _______________________________________________________________________________
set /p =°´ÈÎÒâ¼ü·µ»Ø²Ëµ¥<nul&pause>nul
goto memuv2
:68
cls
...
for /f "delims=" %%a in ('"fsutil fsinfo drives"') do (set sypf=%%a)
set sypf=%sypf:~5%
echo µ±Ç°ÒÑÓĞÅÌ·û: %sypf%
echo ĞéÄâÅÌ·û:
for /f "delims=" %%a in ('"subst"') do (echo %%a)
echo _______________________________________________________________________________
set newpf=
set /p newpf=ÊäÈëÒª´´½¨µÄĞÂÅÌ·û:
if not defined newpf goto 68
set newpf|findstr /i "\<[a-z]\>">nul
if "%errorlevel%" neq "0" echo ÎŞĞ§ÊäÈë&timeout /t 2 /nobreak>nul&goto 68(1)
set gllj=
set /p gllj=ÊäÈëÒª¹ØÁªµÄÂ·¾¶:
...
subst %newpf%: %gllj%
if "%errorlevel%" equ "0" (echo ´´½¨³É¹¦&timeout /t 2 /nobreak>nul&goto 68) else (echo ´´½¨Ê§°Ü&timeout /t 2 /nobreak>nul&goto 68)
:68(2)
title É¾³ıĞéÄâÅÌ·û - %system%
cls
echo ĞéÄâÅÌ·û:
for /f "delims=" %%a in ('"subst"') do (echo %%a)
echo _______________________________________________________________________________
set xzxnp=
set /p xzxnp=ÊäÈëÒªĞ¶ÔØµÄÅÌ·û:
if not defined xzxnp goto 68
set xzxnp|findstr /i "\<[a-z]\>">nul
if "%errorlevel%" neq "0" echo ÎŞĞ§ÊäÈë&timeout /t 2 /nobreak>nul&goto 68(2)
subst %xzxnp%: /d
if "%errorlevel%" equ "0" (echo Ğ¶ÔØ³É¹¦&timeout /t 2 /nobreak>nul&goto 68) else (echo Ğ¶ÔØÊ§°Ü&timeout /t 2 /nobreak>nul&goto 68)
:69
title ½âÑ¹msi°²×°ÎÄ¼ş - %system%
cls
set msiurl=
...
set server=
if defined !sysid! (echo ÏµÍ³Ãû³Æ: %system%) else (call :colortxt c Ã»ÓĞµ±Ç°ÏµÍ³µÄ¼¤»îÃÜÔ¿&echo;)
ping /n 1 www.baidu.com>nul||call :colortxt c Ã»ÓĞÍøÂçÁ¬½Ó&echo;
echo ÇëÑ¡ÔñKMS·şÎñÆ÷
echo _______________________________________________________________________________
...
goto memuv2
:72
title curl¶à½ø³ÌÏÂÔØ - %system%
cls
if not exist %systemroot%\system32\curl.exe (
if not exist .\curl.exe (echo Ã»ÓĞÕÒµ½curl.exe&timeout /t 2 /nobreak>nul&&goto memuv2))
:72.1
cls
set filename=
set url=
set /p url=ÊäÈëÏÂÔØÁ´½Ó(e=·µ»Ø): 
if not defined url echo Á´½Ó²»ÄÜÎª¿Õ!&timeout /t 2 /nobreak>nul&&goto 72.1
if "!url!" equ "e" goto memuv2
set tr=
set /p tr=ÊäÈëÏÂÔØ½ø³ÌÊı(Ä¬ÈÏ16): 
if not defined tr set tr=16
set tr|findstr "\<[0-9]*\>">nul
if !errorlevel! neq 0 (echo Ö»ÄÜÊäÈëÊı×Ö!&timeout /t 2 /nobreak>nul&&goto 72.1)
set dir=
set /p dir=ÊäÈë±£´æÂ·¾¶(Ä¬ÈÏµ±Ç°DOS¹¤¾ßÏäËùÔÚÂ·¾¶): 
if not defined dir (for /f "delims=" %%a in ("!weizhi!") do (set dir=%%~dpa))
if not exist "!dir!" (echo Â·¾¶ !dir! ²»´æÔÚ&timeout /t 2 /nobreak>nul&goto 72.1)
dir /ad !dir!>nul 2>nul||echo Â·¾¶ !dir! ²»ÊÇÒ»¸öÎÄ¼ş¼Ğ&&timeout /t 2 /nobreak>nul&&goto 72.1
cls
echo ¿ªÊ¼»ñÈ¡ÎÄ¼şĞÅÏ¢...
set filename=
...
if not defined filename (set /p filename=ÊäÈëÎÄ¼şÃû: )
if not defined filename (set filename=curlÏÂÔØÎÄ¼ş)
...
echo ÎÄ¼ş´óĞ¡:	!dw!
if "!trflag!" neq "bytes" (echo;¸ÃÁ´½Ó²»Ö§³Ö¶àÏß³Ì´«Êä,½ø³ÌÊı×Ô¶¯ÉèÖÃÎª1)
echo;½ø³ÌÊı:		!tr!
echo;´«ÊäÆ¬¶Î´óĞ¡:	!fd!+!ys!
echo;±£´æÂ·¾¶:	!dir!
echo;_______________________________________________________________________________
set /p =°´ÈÎÒâ¼ü¿ªÊ¼ÏÂÔØ<nul&pause>nul
cls
echo;¿ªÊ¼ÏÂÔØÎÄ¼ş...
title curl¶à½ø³ÌÏÂÔØ - µÈ´ıÎÄ¼şÏÂÔØÍê³É(°´e·µ»Ø²Ëµ¥) - %system%
...
call :colortxt a µÈ´ıÎÄ¼şÏÂÔØÍê³É^(°´e·µ»Ø²Ëµ¥^)...
set /p =!cswz!u<nul
)
for /l %%a in (1,1,!tr!) do (
	set ssdx=%%~za
...
if %%~za geq 1024 (
call :xdwjs %%~za b dw
echo;ÎÄ¼ş´óĞ¡:	%%~za×Ö½Ú Ô¼!dw!) else (echo ÎÄ¼ş´óĞ¡:	%%~za×Ö½Ú)
echo;±£´æÂ·¾¶:	%%~dpa
)) else (
forfiles /p %~dp0 /m %~nx0 /c "%comspec% /c set /p =0x07<nul"
...
:update
cls
title ¸üĞÂDOS¹¤¾ßÏä - µ±Ç°°æ±¾: %ver% - %system%
...
::bitsadmin /transfer ¼ì²é×îĞÂ°æ±¾... /priority FOREGROUND https://cdn.jsdelivr.net/gh/Trustedinstall/dostool/update.js %temp%\dostoolupdate
:jcgxjs
cls
for /f "delims=: tokens=2" %%a in (%temp%\dostoolupdate) do (set doshash="%%a")
for /f "delims=: tokens=1" %%a in (%temp%\dostoolupdate) do (
set /a gxjg=%%a-!ver!
if !gxjg! gtr 0 (set /p =¼ì²éµ½¸üĞÂ°æ±¾: <nul
call :colortxt a %%a&echo;&goto startupdate) else (echo Ã»ÓĞ¼ì²éµ½¸üĞÂ°æ±¾))
...
call :colortxt c ÎÄ¼şÎŞĞ§&echo;&timeout /t 2 /nobreak>nul
if "!tzwz!" equ "!start!" (goto memuv2) else (goto !tzwz!)
::bitsadmin /transfer ÏÂÔØ¸üĞÂÖĞ... /priority FOREGROUND https://cdn.jsdelivr.net/gh/Trustedinstall/dostool/dostool.js %weizhi%&start %comspec% /c %0&exit 0
:sjc
set kssj=%1
set jssj=%2
set kssj=%kssj:"=%
...
if %F% equ 0 (set T=%M%Ãë%N%ºÁÃë) else set T=%F%·Ö%M%Ãë%N%ºÁÃë
if %s% neq 0 set t=%s%Ğ¡Ê±%F%·Ö%M%Ãë%N%ºÁÃë
set %~3=%T%
Goto :eof
:cf
set num=0
